...
class ScheduleModelDrugprices extends ListModel
{
	...
	protected function configureTables()
	{
		...
		$queryHelper->addTable('drugprice', '#__schedule_drugprices')
			->addTable('category',  '#__categories', 'drugprice.catid      = category.id')
			->addTable('user',      '#__users',      'drugprice.created_by = user.id')
			->addTable('viewlevel', '#__viewlevels', 'drugprice.access     = viewlevel.id')
			->addTable('lang',      '#__languages',  'drugprice.language   = lang.lang_code');
