...
namespace Schedule\Listener\Pro;
...
class ProListener extends \JEvent
{
	...
	public function onToolbarAppendButton($context, $args = array())
	{
		...
		switch($context){
			case 'preferences' :
				...
				$args[] = 'administrator/components/com_schedule/includes/plugins/pro' ;
				break;
		}
		*/
	}
	...
	/**
	 * Schedule prepare content method
	...
	/**
	 * Schedule after display title method
	...
	/**
	 * Schedule before display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Schedule after display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Schedule before save content method
	...
	/**
	 * Schedule after save content method
	...
	/**
	 * Schedule on change state method.
	 *
	 * @param   string $context The context for the content passed to the plugin.
