...
<div id="schedule" class="windwalker addresses tablelist row-fluid">
	<form action="<?php echo JURI::getInstance(); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		...
		<table id="addressList" class="adminlist table table-striped modal-list">
			<thead>
			<tr>
				<!--TITLE-->
				<th class="center">
					<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'address.title'); ?>
				</th>
				...
				<!--CREATED-->
				<th class="center">
					<?php echo $grid->sortTitle('JDATE', 'address.created'); ?>
				</th>
