...
/**
 * Class DrugpricesHtmlView
 *
 * @since 1.0
 */
class ScheduleViewDrugpricesHtml extends GridView
{
	/**
	 * Property prefix.
	 *
	...
	public function __construct(Model $model = null, Container $container = null, $config = array(), \SplPriorityQueue $paths = null)
	{
		$config['grid'] = array(
			...
			'view_name' => 'drugprice',
			'view_item' => 'drugprice',
			'view_list' => 'drugprices',

			// Column which we allow to drag sort
			'order_column'   => 'drugprice.catid, drugprice.ordering',

			// Table id
			'order_table_id' => 'drugpriceList',
