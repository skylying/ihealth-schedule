...
<div id="schedule" class="windwalker drugs tablelist row-fluid">
	<form action="<?php echo JURI::getInstance(); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		...
		<table id="drugList" class="adminlist table table-striped modal-list">
			<thead>
			<tr>
				<!--TITLE-->
				<th class="center">
					<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'drug.title'); ?>
				</th>
				...
				<!--CREATED-->
				<th class="center">
					<?php echo $grid->sortTitle('JDATE', 'drug.created'); ?>
				</th>
