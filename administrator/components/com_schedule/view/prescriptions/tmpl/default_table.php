...
<!-- LIST TABLE -->
<table id="prescriptionList" class="table table-striped adminlist">
...
<tr>
	...
	<th width="5%" class="nowrap center">
		<?php echo $grid->sortTitle('JSTATUS', 'prescription.state'); ?>
	</th>

	<!--TITLE-->
	<th class="center">
		<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'prescription.title'); ?>
	</th>
	...
	<!--CREATED-->
	<th width="10%" class="center">
		<?php echo $grid->sortTitle('JDATE', 'prescription.created'); ?>
	</th>
	...
	<th width="1%" class="nowrap center">
		<?php echo $grid->sortTitle('JGRID_HEADING_ID', 'prescription.id'); ?>
	</th>
</tr>
</thead>
...
<?php foreach ($data->items as $i => $item)
	...
	$grid->setItem($item, $i);
	?>
	<tr class="prescription-row" sortable-group-id="<?php echo $item->catid; ?>">
		<!-- DRAG SORT -->
