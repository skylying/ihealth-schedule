...
<div id="modal-status-cancel" class="modal hide fade" tabindex="-1" role="dialog" style="overflow: hidden;">
	...
	<div class="modal-body">
		<form action="<?php echo JUri::getInstance(); ?>" method="post" id="form-status-cancel" style="margin:0;">
			<div class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-6 control-label" for="status-cancel-note">
						備註
					</label>
					<div class="col-sm-6">
				...
				<!-- Hidden Inputs -->
				<div class="hide">
					<input type="hidden" name="task" value="schedules.status" />
...
<div id="modal-status-pause" class="modal hide fade" tabindex="-1" role="dialog" style="overflow: hidden;">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		...
		<form action="<?php echo JUri::getInstance(); ?>" method="post" id="form-status-pause" style="margin:0;">
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-6">
						<div class="radio">
							<input type="radio" id="status-cancel-reason-1" name="cancel" value="hospitalized">
							<label for="status-cancel-reason-1">住院</label>
						</div>
						<div class="radio">
							<input type="radio" id="status-cancel-reason-4" name="cancel" value="other">
							<label for="status-cancel-reason-4">其他</label>
	...
	<div class="modal-footer">
		<button type="button" class="btn btn-danger" onclick="jQuery('#form-status-pause').submit();">暫緩排程</button>
	</div>
</div>
