...
<div id="schedule" class="windwalker senders tablelist row-fluid">
	<form action="<?php echo JURI::getInstance(); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		...
		<table id="senderList" class="adminlist table table-striped modal-list">
			<thead>
			<tr>
				<!--TITLE-->
				<th class="center">
					<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'sender.title'); ?>
				</th>
				...
				<!--CREATED-->
				<th class="center">
					<?php echo $grid->sortTitle('JDATE', 'sender.created'); ?>
				</th>
				...
				<th width="1%" class="nowrap center">
					<?php echo $grid->sortTitle('JGRID_HEADING_ID', 'sender.id'); ?>
				</th>
			</tr>
			</thead>
